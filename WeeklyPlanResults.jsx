...
StyleSheet.create({
  ...
  topBarBackText: { fontSize: 14, color: t.fg("#374151"), fontWeight: "500" },
  topBarTitle: { fontSize: 15, fontWeight: "700", color: t.fg("#253B63") },
  regenBtn: {
    flexDirection: "row",
    alignItems: "center",
    gap: 5,
  ...
  regenBtnText: { fontSize: 13, fontWeight: "600", color: t.fg("#FFFFFF") },
  ...
  badgeSodium: { backgroundColor: t.bg("#FEE2E2") },
  badgeLabel: { fontSize: 10, color: t.fg("#6B7280"), fontWeight: "600", marginBottom: 1 },
  badgeLabelSodium: { color: t.fg("#DC2626") },
  badgeValue: { fontSize: 12, color: t.fg("#111827"), fontWeight: "600" },
  badgeValueSodium: { color: t.fg("#B91C1C") },
  ...
  ingredientDot: { fontSize: 12, color: t.fg("#9CA3AF"), lineHeight: 18 },
  ingredientItem: { flex: 1, fontSize: 12, color: t.fg("#374151"), lineHeight: 18 },
  ingredientAmount: { fontSize: 12, color: t.fg("#6B7280"), lineHeight: 18 },
  ...
  saveBtnText: { fontSize: 13, fontWeight: "700", color: t.fg("#FFFFFF") },
  savedBadge: {
    flexDirection: "row",
    alignItems: "center",
    gap: 6,
  ...
  savedBadgeText: { fontSize: 13, color: t.fg("#047857"), fontWeight: "600" },
  saveError: { fontSize: 12, color: t.fg("#EF4444"), marginTop: 4 },
  ...
  retryBtnText: { fontSize: 15, fontWeight: "700", color: t.fg("#FFFFFF") },
  editBtn: {
    height: 44,
  ...
  editBtnText: { fontSize: 14, color: t.fg("#6B7280"), fontWeight: "500" },
});
