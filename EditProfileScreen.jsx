...
StyleSheet.create({
  ...
  loadingWrap: { flex: 1, backgroundColor: t.bg("#FFFFFF"), alignItems: "center", justifyContent: "center" },
  ...
  logoText: { fontSize: 15, fontWeight: "700", color: t.fg("#18233D") },
  avatarSection: { alignItems: "center", marginBottom: 20 },
  avatarCircle: {
    width: 108,
    height: 108,
    borderRadius: 54,
    backgroundColor: t.bg("#DCE7FB"),
    alignItems: "center",
    justifyContent: "center",
  },
  avatarText: { fontSize: 34, fontWeight: "900", color: t.fg("#173E6A") },
  avatarAction: {
    marginTop: -16,
    marginLeft: 72,
    width: 36,
  ...
  editPhotoLabel: { marginTop: 6, fontSize: 12, fontWeight: "700", color: t.fg("#0B5FA5") },
  nameRow: { flexDirection: "row", marginBottom: 12 },
  nameHalf: { flex: 1, marginRight: 6 },
  nameHalfRight: { flex: 1, marginLeft: 6 },
  inputGroup: { marginBottom: 12 },
  inputLabel: { marginBottom: 6, fontSize: 10, fontWeight: "800", color: t.fg("#6B7280") },
  input: {
    height: 48,
    borderRadius: 10,
    backgroundColor: t.bg("#EAF0FF"),
    borderWidth: 1,
    borderColor: t.bd("#D8E1F5"),
    paddingHorizontal: 14,
    fontSize: 14,
    color: t.fg("#18233D"),
  },
  inputError: { borderColor: t.bd("#EF4444"), backgroundColor: t.bg("#FFF5F5") },
  errorText: { marginTop: 4, fontSize: 12, color: t.fg("#EF4444") },
  pickerButton: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  pickerText: { fontSize: 14, color: t.fg("#18233D"), flex: 1 },
  pickerPlaceholder: { color: t.fg("#9CA3AF") },
  divider: { height: 1, backgroundColor: t.bg("#E5E7EB"), marginVertical: 16 },
  sectionHeading: { fontSize: 14, fontWeight: "800", color: t.fg("#374151"), marginBottom: 12 },
  saveButton: {
    marginTop: 8,
    height: 52,
    borderRadius: 14,
  ...
  saveButtonText: { fontSize: 15, fontWeight: "800", color: t.fg("#FFFFFF") },
  cancelButton: {
    marginTop: 10,
    height: 52,
    borderRadius: 14,
  ...
  cancelButtonText: { fontSize: 15, fontWeight: "700", color: t.fg("#55627D") },
  ...
  pickerHandle: {
    ...
    height: 5,
    borderRadius: 999,
    backgroundColor: t.bg("#D0D5DD"),
    marginBottom: 16,
  },
  pickerSheetTitle: { fontSize: 18, fontWeight: "800", color: t.fg("#18233D"), marginBottom: 12 },
  pickerOption: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  pickerOptionSelected: { backgroundColor: t.bg("#EAF0FF"), borderRadius: 8, paddingHorizontal: 8 },
  pickerOptionText: { fontSize: 16, color: t.fg("#374151") },
  pickerOptionTextSelected: { fontWeight: "700", color: t.fg("#0B5FA5") },
});
