...
StyleSheet.create({
  ...
  tabChipActive: {
    borderColor: t.bd("#1877F2"),
  },
  tabText: { fontSize: 22, color: t.fg("#1877F2"), fontWeight: "500" },
  tabTextActive: { fontWeight: "800" },
  waterCard: {
    borderRadius: 30,
    backgroundColor: t.bg("#000000"),
    padding: 20,
    marginBottom: 22,
  },
  waterHeader: {
  ...
  waterTitle: { fontSize: 26, fontWeight: "800", color: t.fg("#FFFFFF") },
  waterSubtext: { fontSize: 15, color: t.fg("#FFFFFF"), marginTop: 4 },
  waterMlText: { fontSize: 16, color: t.fg("#1990FF"), fontWeight: "800", marginTop: 8 },
  ...
  summaryTitle: { fontSize: 26, fontWeight: "800", color: t.fg("#111111"), marginBottom: 18 },
  summaryRow: {
    flexDirection: "row",
    alignItems: "center",
    marginBottom: 12,
  ...
  summaryTrack: {
    ...
    height: 10,
    borderRadius: 99,
    backgroundColor: t.bg("#D9D9D9"),
    marginHorizontal: 14,
    overflow: "hidden",
  },
  summaryFill: { height: "100%", borderRadius: 99 },
  summaryValue: { width: 52, textAlign: "right", fontSize: 16, color: t.fg("#111111") },
});
