...
StyleSheet.create({
  ...
  cardSub: { fontSize: 13, color: t.fg("#6B7280"), marginBottom: 16, lineHeight: 18 },
  ...
  toggleBtnYes: { borderColor: t.bd("#047857"), backgroundColor: t.bg("#ECFDF5") },
  toggleBtnNo: { borderColor: t.bd("#EF4444"), backgroundColor: t.bg("#FEF2F2") },
  toggleBtnText: { fontSize: 13, color: t.fg("#374151"), fontWeight: "500" },
  toggleBtnTextActive: { fontWeight: "700" },

  chipHint: { fontSize: 11, color: t.fg("#9CA3AF"), marginBottom: 10 },
  ...
  mealChipLiked: { borderColor: t.bd("#047857"), backgroundColor: t.bg("#ECFDF5") },
  mealChipDisliked: { borderColor: t.bd("#DC2626"), backgroundColor: t.bg("#FEF2F2") },
  mealChipText: { fontSize: 12, color: t.fg("#374151"), fontWeight: "500" },
  mealChipTextLiked: { color: t.fg("#047857"), fontWeight: "600" },
  mealChipTextDisliked: { color: t.fg("#DC2626"), fontWeight: "600" },
  ...
  errorText: { fontSize: 13, color: t.fg("#EF4444"), marginTop: 8 },
  ...
  submitBtnText: { fontSize: 15, fontWeight: "700", color: t.fg("#FFFFFF") },
  ...
  unavailableText: { flex: 1, fontSize: 13, color: t.fg("#6B7280"), lineHeight: 18 },

  thankyouCard: {
    margin: 14,
    backgroundColor: t.bg("#F0FDF4"),
    borderRadius: 16,
    padding: 24,
    alignItems: "center",
    borderWidth: 1,
    borderColor: t.bd("#BBF7D0"),
  },
  ...
  thankyouSub: { fontSize: 13, color: t.fg("#059669"), textAlign: "center" },
});
