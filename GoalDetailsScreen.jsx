...
StyleSheet.create({
  ...
  ringValue: { fontSize: 34, fontWeight: "800", color: t.fg("#111111") },
  ringUnit: { fontSize: 16, color: t.fg("#555555") },
  heroHeadline: { fontSize: 20, fontWeight: "700", color: t.fg("#111111"), textAlign: "center" },
  metricCard: {
    flexDirection: "row",
    alignItems: "center",
    borderRadius: 24,
  ...
  metricBody: { flex: 1 },
  metricLabel: { fontSize: 15, color: t.fg("#555555"), marginBottom: 4 },
  metricValue: { fontSize: 22, fontWeight: "800", color: t.fg("#111111") },
  nutritionLink: { alignItems: "center", paddingVertical: 12 },
  nutritionLinkText: { fontSize: 14, fontWeight: "700", color: t.fg("#1877F2") },
});
