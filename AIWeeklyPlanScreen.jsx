...
StyleSheet.create({
  ...
  loadingTitle: { marginTop: 20, fontSize: 22, fontWeight: "800", color: t.fg("#18233D"), textAlign: "center" },
  loadingSubtitle: { marginTop: 12, fontSize: 15, color: t.fg("#6B7280"), textAlign: "center", lineHeight: 22 },
  configContent: { padding: 20, paddingBottom: 40 },
  configTitle: { fontSize: 30, fontWeight: "800", color: t.fg("#18233D"), marginBottom: 8 },
  configSubtitle: { fontSize: 15, color: t.fg("#6B7280"), lineHeight: 22, marginBottom: 24 },
  sectionLabel: { fontSize: 14, fontWeight: "800", color: t.fg("#374151"), marginBottom: 12, marginTop: 4 },
  ...
  chipActive: { borderColor: t.bd("#2B78C5"), backgroundColor: t.bg("#EAF2FF") },
  chipText: { fontSize: 14, color: t.fg("#6B7280"), fontWeight: "600" },
  chipTextActive: { color: t.fg("#2B78C5") },
  ...
  goalOptionActive: { borderColor: t.bd("#2B78C5"), backgroundColor: t.bg("#EAF2FF") },
  goalText: { fontSize: 15, color: t.fg("#374151") },
  goalTextActive: { fontWeight: "700", color: t.fg("#2B78C5") },
  infoCard: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: t.bg("#EAF2FF"),
    borderRadius: 14,
    padding: 14,
    marginBottom: 20,
  },
  infoText: { flex: 1, marginLeft: 10, fontSize: 13, color: t.fg("#374151"), lineHeight: 19 },
  primaryButton: {
    height: 54,
    borderRadius: 16,
  ...
  primaryButtonText: { fontSize: 16, fontWeight: "800", color: t.fg("#FFFFFF") },
  secondaryButton: {
    height: 50,
    borderRadius: 16,
    borderWidth: 1.5,
    borderColor: t.bd("#2B78C5"),
    alignItems: "center",
    justifyContent: "center",
    flexDirection: "row",
  },
  secondaryButtonText: { fontSize: 15, fontWeight: "700", color: t.fg("#2B78C5") },
  buttonDisabled: { opacity: 0.65 },
  resultContent: { padding: 20, paddingBottom: 40 },
  resultHeader: { marginBottom: 20 },
  resultTitle: { fontSize: 26, fontWeight: "800", color: t.fg("#18233D"), marginBottom: 4 },
  resultSubtitle: { fontSize: 14, color: t.fg("#6B7280") },
  dayCard: {
    borderRadius: 18,
    borderWidth: 1,
    borderColor: t.bd("#E5E7EB"),
  ...
  dayName: { fontSize: 16, fontWeight: "800", color: t.fg("#253B63"), marginBottom: 10 },
  mealRow: {
    flexDirection: "row",
    alignItems: "center",
    marginBottom: 8,
  ...
  mealInfo: { flex: 1 },
  mealTitle: { fontSize: 14, fontWeight: "600", color: t.fg("#253B63") },
  mealMeta: { fontSize: 12, color: t.fg("#9CA3AF"), marginTop: 2 },
});
