...
const makeStyles = (t) =>
StyleSheet.create({
  container: { flex: 1, backgroundColor: t.bg("#000000") },
  camera: { flex: 1 },
  ...
  scanHintText: { color: t.fg("#FFFFFF"), fontSize: 13, fontWeight: "500", textAlign: "center", opacity: 0.85 },
  ...
  torchBtnText: { color: t.fg("#FFFFFF"), fontSize: 13, fontWeight: "600" },
  ...
  manualBtnText: { color: t.fg("#FFFFFF"), fontSize: 14, fontWeight: "700" },

  errorRow: { flexDirection: "row", alignItems: "center", gap: 6, marginTop: 8 },
  errorText: { color: t.fg("#FCA5A5"), fontSize: 12 },
  ...
  loadingText: { color: t.fg("#FFFFFF"), fontSize: 14, fontWeight: "500" },
  ...
  resultTitle: { fontSize: 24, fontWeight: "800", color: t.fg("#253B63"), marginBottom: 16 },
  ...
  allergenCardLabel: { fontSize: 12, color: t.fg("#94A3B8"), fontWeight: "500", marginBottom: 2 },
  allergenCardStatus: { fontSize: 14, fontWeight: "700" },
  statusChip: { borderRadius: 999, paddingHorizontal: 12, paddingVertical: 5 },
  chipSafe: { backgroundColor: t.bg("#DCFCE7") },
  chipWarning: { backgroundColor: t.bg("#FEF3C7") },
  chipDanger: { backgroundColor: t.bg("#FEE2E2") },
  statusChipText: { fontSize: 12, fontWeight: "700", color: t.fg("#374151") },
  ...
  metricDivider: { width: 1, height: 32, backgroundColor: t.bg("#E5E7EB") },
  metricValue: { fontSize: 16, fontWeight: "800", color: t.fg("#253B63"), marginBottom: 2 },
  metricLabel: { fontSize: 11, color: t.fg("#94A3B8"), fontWeight: "500" },
  ...
  infoCardTitle: { fontSize: 13, fontWeight: "700", color: t.fg("#253B63"), marginBottom: 5 },
  infoCardText: { fontSize: 13, color: t.fg("#667085"), lineHeight: 19 },
  ...
  primaryBtnText: { fontSize: 15, fontWeight: "700", color: t.fg("#FFFFFF") },
  savedBtn: { backgroundColor: t.bg("#22C55E") },

  secondaryBtn: {
    height: 46,
    borderRadius: 23,
    borderWidth: 1.5,
    borderColor: t.bd("#CBD5E1"),
    alignItems: "center",
    justifyContent: "center",
  },
  secondaryBtnText: { fontSize: 15, fontWeight: "600", color: t.fg("#667085") },

  permissionSafe: { flex: 1, backgroundColor: t.bg("#FFFFFF") },
  permissionContainer: {
    flex: 1,
    alignItems: "center",
    justifyContent: "center",
  ...
  permissionTitle: { fontSize: 22, fontWeight: "800", color: t.fg("#253B63"), marginBottom: 12, textAlign: "center" },
  permissionText: { fontSize: 14, color: t.fg("#667085"), textAlign: "center", lineHeight: 22, marginBottom: 32 },
});
