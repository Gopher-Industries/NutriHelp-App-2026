...
StyleSheet.create({
  ...
  rowValue: { fontSize: 16, color: t.fg("#111111") },
  track: { height: 14, borderRadius: 99, backgroundColor: t.bg("#D9D9D9"), overflow: "hidden" },
  fill: { height: "100%", borderRadius: 99 },
  rowProgress: { marginTop: 8, fontSize: 12, color: t.fg("#888888") },
  emptyState: { alignItems: "center", paddingVertical: 48 },
  emptyIcon: { fontSize: 48, marginBottom: 14 },
  emptyTitle: { fontSize: 18, fontWeight: "700", color: t.fg("#374151"), marginBottom: 8 },
  emptyBody: { fontSize: 14, color: t.fg("#9CA3AF"), textAlign: "center", lineHeight: 21, marginBottom: 20 },
  planButton: {
    height: 48,
    borderRadius: 14,
  ...
  planButtonText: { fontSize: 14, fontWeight: "700", color: t.fg("#FFFFFF") },
});
