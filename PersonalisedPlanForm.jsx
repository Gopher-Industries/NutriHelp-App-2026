...
StyleSheet.create({
  ...
  scroll: { flex: 1, backgroundColor: t.bg("#F8FAFC") },
  scrollContent: { paddingHorizontal: 16, paddingTop: 20, paddingBottom: 40 },
  pageTitle: { fontSize: 24, fontWeight: "800", color: t.fg("#253B63"), marginBottom: 6 },
  pageSubtitle: { fontSize: 14, color: t.fg("#6B7280"), marginBottom: 20, lineHeight: 20 },
  ...
  sectionTitle: { fontSize: 15, fontWeight: "700", color: t.fg("#253B63") },
  ...
  selectValue: { fontSize: 14, color: t.fg("#111827"), flex: 1 },
  ...
  textInputError: { borderColor: t.bd("#EF4444") },
  errorText: { fontSize: 12, color: t.fg("#EF4444"), marginTop: 4 },
  ...
  charCount: { fontSize: 11, color: t.fg("#9CA3AF"), textAlign: "right", marginTop: 4 },
  ...
  chipActive: { borderColor: t.bd("#047857"), backgroundColor: t.bg("#ECFDF5") },
  chipText: { fontSize: 13, color: t.fg("#374151"), fontWeight: "500" },
  chipTextActive: { color: t.fg("#047857"), fontWeight: "600" },
  ...
  groupBtnActive: { borderColor: t.bd("#047857"), backgroundColor: t.bg("#ECFDF5") },
  groupBtnTitle: { fontSize: 13, fontWeight: "600", color: t.fg("#374151") },
  groupBtnTitleActive: { color: t.fg("#047857") },
  groupBtnSub: { fontSize: 10, color: t.fg("#9CA3AF"), marginTop: 2 },
  groupBtnSubActive: { color: t.fg("#059669") },
  ...
  submitBtn: {
    ...
    height: 54,
    borderRadius: 16,
    backgroundColor: t.bg("#047857"),
  },
  submitBtnText: { fontSize: 16, fontWeight: "700", color: t.fg("#FFFFFF") },
  ...
  modalOptionActive: { backgroundColor: t.bg("#F0FDF4") },
  modalOptionText: { fontSize: 15, color: t.fg("#374151") },
  modalOptionTextActive: { color: t.fg("#047857"), fontWeight: "600" },
});
