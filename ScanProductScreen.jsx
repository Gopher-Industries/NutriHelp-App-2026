...
StyleSheet.create({
  ...
  pageTitle: { fontSize: 30, fontWeight: "800", color: t.fg("#253B63"), marginBottom: 4 },
  pageSubtitle: { fontSize: 14, color: t.fg("#66758F"), marginBottom: 22 },
  ...
  scanCardText: { flex: 1 },
  scanCardTitle: { fontSize: 16, fontWeight: "700", color: t.fg("#253B63"), marginBottom: 3 },
  scanCardDesc: { fontSize: 13, color: t.fg("#667085"), lineHeight: 18 },
  ...
  historyTitle: { fontSize: 17, fontWeight: "700", color: t.fg("#253B63") },
  historyBadge: {
    backgroundColor: t.bg("#EFF6FF"),
    borderRadius: 10,
    paddingHorizontal: 8,
  ...
  historyBadgeText: { fontSize: 12, fontWeight: "700", color: t.fg("#2A78C5") },
  ...
  emptyText: { fontSize: 16, fontWeight: "700", color: t.fg("#94A3B8") },
  emptySubtext: { fontSize: 13, color: t.fg("#CBD5E1") },
  ...
  historyInfo: { flex: 1 },
  historyName: { fontSize: 14, fontWeight: "600", color: t.fg("#253B63"), marginBottom: 2 },
  historyMeta: { fontSize: 12, color: t.fg("#94A3B8") },
  ...
  sheetTitle: { fontSize: 24, fontWeight: "800", color: t.fg("#253B63"), marginBottom: 16 },
  ...
  allergenLabel: { fontSize: 12, color: t.fg("#94A3B8"), fontWeight: "500", marginBottom: 2 },
  ...
  chipText: { fontSize: 12, fontWeight: "700", color: t.fg("#374151") },
  ...
  closeBtnText: { fontSize: 15, fontWeight: "600", color: t.fg("#667085") },
});
