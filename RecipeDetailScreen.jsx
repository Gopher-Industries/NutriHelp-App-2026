...
StyleSheet.create({
  ...
  pageChrome: { flex: 1 },
  scrollViewport: { backgroundColor: t.bg("#FFFFFF") },
  flex1: { flex: 1 },
  ...
  tabCellInactive: { backgroundColor: t.bg("transparent") },
  ...
  nutritionShell: { borderRadius: 12, backgroundColor: t.bg("#F9FAFB"), padding: 12 },
  ...
  reviewComposerTitle: { fontSize: 18, fontWeight: "700", color: t.fg("#253B63") },
  ...
  reviewListTitle: { fontSize: 18, fontWeight: "700", color: t.fg("#253B63") },
  reviewListCount: {
    minWidth: 26,
    textAlign: "center",
    fontSize: 13,
