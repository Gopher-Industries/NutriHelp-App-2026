    ...
    <SafeAreaView style={styles.safeArea} edges={["top"]}>
      <ScrollView style={styles.screen} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("NutritionCalculatorScreen")}
          accessibilityRole="button"
          accessibilityLabel="Open nutrition calculator"
        >
          <Ionicons name="calculator-outline" size={18} color="#0B5FA5" />
          <Text style={styles.calcButtonText}>Nutrition Calculator</Text>
          <Ionicons name="chevron-forward" size={16} color="#0B5FA5" />
        </Pressable>
...
const styles = StyleSheet.create({
  ...
  calcButtonText: { flex: 1, fontSize: 14, fontWeight: "700", color: "#0B5FA5" },
