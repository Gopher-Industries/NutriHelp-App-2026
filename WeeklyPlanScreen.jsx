...
StyleSheet.create({
  ...
  monthLabelText: { fontSize: 18, fontWeight: "700", color: t.fg("#253B63") },
  ...
  dayChipActive: {
    borderColor: t.bd("#2A78C5"),
    backgroundColor: t.bg("#2A78C5"),
  },
  dayChipToday: {
    borderColor: t.bd("#93C5FD"),
    backgroundColor: t.bg("#EFF6FF"),
  },
  dayNumber: { fontSize: 16, fontWeight: "800", color: t.fg("#253B63") },
  dayNumberActive: { color: t.fg("#FFFFFF") },
  dayWeek: { marginTop: 2, fontSize: 11, color: t.fg("#6B7280") },
  dayWeekActive: { color: t.fg("#DBEAFE") },

  pageTitle: { marginTop: 6, fontSize: 28, fontWeight: "800", color: t.fg("#253B63") },
  pageSubtitle: { marginTop: 4, marginBottom: 14, fontSize: 14, color: t.fg("#667085") },
  aiHeroCard: {
    marginBottom: 14,
    flexDirection: "row",
    alignItems: "center",
    borderRadius: 16,
    borderWidth: 1,
    borderColor: t.bd("#86EFAC"),
    backgroundColor: t.bg("#ECFDF5"),
    paddingHorizontal: 14,
    paddingVertical: 10,
    gap: 12,
  },
  aiHeroIconWrap: {
    ...
    alignItems: "center",
    justifyContent: "center",
    backgroundColor: t.bg("#D1FAE5"),
    marginRight: 10,
  },
  aiHeroIconEmoji: { fontSize: 22 },
  aiHeroTextWrap: { flex: 1, minWidth: 0 },
  aiHeroTitle: { fontSize: 15, fontWeight: "800", color: t.fg("#047857") },
  aiHeroSubtitle: { marginTop: 2, fontSize: 12, color: t.fg("#059669") },

  loadingBox: { paddingVertical: 40, alignItems: "center" },
  loadingText: { marginTop: 10, fontSize: 14, color: t.fg("#667085") },
  errorBox: { paddingVertical: 28, alignItems: "center" },
  errorText: { fontSize: 15, color: t.fg("#B91C1C"), marginBottom: 12 },
  retryBtn: {
    minHeight: 40,
    borderRadius: 20,
    backgroundColor: t.bg("#2A78C5"),
  ...
  retryBtnText: { color: t.fg("#FFFFFF"), fontWeight: "700" },
  ...
  slotEmptyTitle: { fontSize: 15, fontWeight: "700", color: t.fg("#253B63") },
  slotEmptySubtitle: { marginTop: 4, fontSize: 13, color: t.fg("#98A2B3"), textAlign: "center" },

  filledRow: { flexDirection: "row", alignItems: "center" },
  mealImage: { width: 84, height: 84, borderRadius: 12, backgroundColor: t.bg("#E5E7EB") },
  mealInfo: { marginLeft: 10, flex: 1, minWidth: 0 },
  mealTitle: { fontSize: 16, fontWeight: "700", color: t.fg("#253B63") },
  mealCuisine: { marginTop: 4, fontSize: 13, fontWeight: "600" },
  mealCalories: { marginTop: 4, fontSize: 13, color: t.fg("#667085") },
  ...
  slotOutlineButtonText: { fontSize: 14, fontWeight: "700", color: t.fg("#2A78C5") },
  slotPrimaryButton: {
    flex: 1,
    minHeight: 42,
    borderRadius: 12,
  ...
  slotPrimaryButtonText: { fontSize: 14, fontWeight: "700", color: t.fg("#FFFFFF") },

  sheetLoading: { alignItems: "center", paddingVertical: 32 },
  sheetLoadingText: { marginTop: 10, fontSize: 14, color: t.fg("#98A2B3") },
  ...
  sheetHandle: {
    ...
    height: 5,
    borderRadius: 999,
    backgroundColor: t.bg("#D1D5DB"),
    marginBottom: 14,
  },
  sheetTitle: { fontSize: 18, fontWeight: "800", color: t.fg("#253B63"), marginBottom: 10 },
  searchInput: {
    height: 46,
    borderRadius: 12,
    borderWidth: 1,
    borderColor: t.bd("#D1D5DB"),
    backgroundColor: t.bg("#F9FAFB"),
    paddingHorizontal: 14,
    fontSize: 15,
    color: t.fg("#253B63"),
    marginBottom: 8,
  ...
  sheetLoadingText: { marginTop: 8, fontSize: 14, color: t.fg("#667085") },
  emptyResults: { alignItems: "center", paddingVertical: 30 },
  emptyResultsText: { fontSize: 14, color: t.fg("#98A2B3") },
  optionRow: {
    flexDirection: "row",
    alignItems: "center",
    borderBottomWidth: 1,
  ...
  optionTitle: { fontSize: 15, fontWeight: "700", color: t.fg("#253B63") },
  optionMeta: { marginTop: 2, fontSize: 12, color: t.fg("#64748B") },
  optionCalories: { marginTop: 2, fontSize: 12, color: t.fg("#2A78C5"), fontWeight: "600" },
  optionAddButton: {
    minHeight: 36,
    borderRadius: 10,
    alignItems: "center",
  ...
  optionAddButtonText: { color: t.fg("#FFFFFF"), fontWeight: "700", fontSize: 13 },
  ...
  pickerYearText: { fontSize: 20, fontWeight: "800", color: t.fg("#253B63") },
  monthGrid: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 8,
  ...
  pickerCancelText: { fontSize: 14, fontWeight: "700", color: t.fg("#475569") },
  pickerApplyBtn: {
    flex: 1,
    minHeight: 40,
    borderRadius: 10,
  ...
  pickerApplyText: { fontSize: 14, fontWeight: "700", color: t.fg("#FFFFFF") },
});
